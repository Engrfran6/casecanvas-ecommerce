...
const ThankYou = () => {
  ...
  console.log('returned data from querry', data);
  console.log('returned orderId from querry', orderId);
        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We at CaseCanvas believe that a phone case doesn't only need to look good, but also
